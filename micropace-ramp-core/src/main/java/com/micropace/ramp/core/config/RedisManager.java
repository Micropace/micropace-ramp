...
public class RedisManager {
    ...
    /** redis操作常用方法类 */
    private com.micropace.ramp.core.config.RedisHelper redisHelper;
    ...
    @Autowired
    public void init() {
        this.redisHelper = new com.micropace.ramp.core.config.RedisHelper(this);
    }
     ...
     * @return RedisHelper
     */
    public com.micropace.ramp.core.config.RedisHelper helper() {
