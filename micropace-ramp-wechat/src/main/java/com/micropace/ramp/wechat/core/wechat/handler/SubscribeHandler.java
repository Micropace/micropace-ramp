...
import com.micropace.ramp.wechat.core.wechat.builder.TextBuilder;
...
import com.micropace.ramp.wechat.service.*;
                ...
                if (wxApp != null) {
                    ...
                    if(WxAppType.TYPE_B.getCode().equals(wxApp.getType())) {
                        ...
                        if(BUser == null) {
                            ...
                            BUser.setStatus(RegisterStatus.DEFAULT.getCode());
